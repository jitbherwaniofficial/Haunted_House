...
const bricksAmbientOnclussionTexture = textureLoader.load('/textures/bricks/ambientOcclusion.jpg')
const bricksNormalTexture = textureLoader.load('/textures/bricks/Normal.jpg')
const bricksRoughnessTexture = textureLoader.load('/textures/bricks/Roughness.jpg')

const grassColorTexture = textureLoader.load('/textures/grass/color.jpg')
const grassAmbientOnclussionTexture = textureLoader.load('/textures/grass/ambientOcclusion.jpg')
const grassNormalTexture = textureLoader.load('/textures/grass/Normal.jpg')
const grassRoughnessTexture = textureLoader.load('/textures/grass/Roughness.jpg')

grassColorTexture.repeat.set(8, 8)
grassAmbientOnclussionTexture.repeat.set(8, 8)
grassNormalTexture.repeat.set(8, 8)
grassRoughnessTexture.repeat.set(8, 8)

grassColorTexture.wrapS = THREE.RepeatWrapping
grassAmbientOnclussionTexture.wrapS = THREE.RepeatWrapping
grassNormalTexture.wrapS = THREE.RepeatWrapping
grassRoughnessTexture.wrapS = THREE.RepeatWrapping

grassColorTexture.wrapT = THREE.RepeatWrapping
grassAmbientOnclussionTexture.wrapT = THREE.RepeatWrapping
...
const walls = new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial({
        ...
        aoMap: bricksAmbientOnclussionTexture,
...
const floor = new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial({
        ...
        aoMap: grassAmbientOnclussionTexture,
